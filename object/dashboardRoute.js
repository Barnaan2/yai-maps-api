...
.delete(authMiddleware.protect,projectMiddleware.checkProject,objectController.deleteObject)

//! ITS AN ENDPOINT FOR THE CUSTOMER FOR MANIPULATING DATA THROUGH THE GUI.
router.route('/project/:id/distance/:latlng/:unit').get(authMiddleware.protect, projectMiddleware.checkProject,objectController.getDistances)
router.route('/project/:id/objects-within/:distance/center/:latlng/:unit').get(authMiddleware.protect, projectMiddleware.checkProject,objectController.getObjectsWithin)
